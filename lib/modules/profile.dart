    ...
    return BlocConsumer<walkieCubit,WalkieStates>(
      ...
      builder: (context,state)
      {
        if(walkieCubit.get(context).getProfileModel!=null) {
            List<Widget> tabs = [
              ProfilePostBuilder(state, context, true),
              ProfilePhotosBuilder(walkieCubit.get(context).getProfileModel),
              ProfileVideosBuilder(
                  walkieCubit.get(context).getProfileModel, false),
            ];
                ...
                builder: (context) => SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      profileData(walkieCubit.get(context).getProfileModel),
                      Card(
...
Widget ProfilePostBuilder(state,context,bool? IsPost){
    ...
    builder:(context)=> Container(
      ...
      child: ListView.separated(
          ...
          itemBuilder: (context,index)=>ProfileItem(
              ...
              walkieCubit.get(context).getProfileModel,
              index,
              context,
              state,IsPost),
          separatorBuilder: (context,index)=>SizedBox(height: 30,),
          itemCount: walkieCubit.get(context).getProfileModel!.data![0].posts!.length),
    ),
