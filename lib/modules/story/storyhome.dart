...
// import 'package:walki/modules/story/storymodel.dart';
// import 'package:walki/modules/story/usermodel.dart';
//
...
//   void initState() {
//     super.initState();
//     storyCubit.get(context).storyInitState(stories:widget.stories,This: this);
//   }
//
//   @override
//   void dispose() {
//     storyCubit.get(context).closepage();
//     super.dispose();
//   }
//
//   @override
...
//     final Story story = widget.stories[cubit.currentIndex];
...
//           onTapDown: (details) => cubit.onTapDown(details, story,context,widget.stories),
//           child: Stack(
//             children: <Widget>[
//               PageView.builder(
...
//                               borderRadius: BorderRadius.circular(20)
//                           ),
//                           child: (cubit.videoController.value.isInitialized)
//                               ?ClipRRect(
//                               borderRadius: BorderRadius.circular(20),
